...
@section('content')
    <div class="container-fluid">
        <!-- Content Start -->
        <a href="{{ route('pengembalian') }}" class="btn btn-outline-primary mb-3">
        ...
        @isset($peminjaman)
         @if($peminjaman->isNotEmpty())
            <div class="card mt-3 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title text-center">Detail Peminjaman Aktif</h5>
                                    ...
                                    <tr class="fade-in">
                                        ...
                                        <td>
                                            @if ($item->book && $item->book->book_cover)
                                                <img src="{{ asset($item->book->book_cover) }}" alt="Cover Buku" style="width: 50px; height: auto; border-radius: 4px;">
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <!-- Form ini akan mengirim ke ID Peminjaman -->
